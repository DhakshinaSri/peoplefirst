    ...
    <section className="w-full bg-white py-24 px-5 sm:px-8 md:px-12 lg:px-20 relative">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20 items-start">
        ...
        <div className="lg:col-span-5 lg:sticky lg:top-32">
          ...
          >
            Managing workplace compliance and employee relations requires consistency, 
            proper systems, and professional guidance. <br />
            We support organizations in maintaining workforce-related processes, strengthening compliance 
            practices, and promoting stable employee relations through practical support solutions.
          </motion.p>
        </div>
